...
public class ProfileSelect : FrameSelector {
    ...
    static List<FrameField> _Fields = [
        new FrameImage ("Avatar") {
            Get = (FrameBacker data) => (data as ProfileSelect)?.Avatar ,
            Set = (FrameBacker data, string? value) => {(data as ProfileSelect)!.Avatar = value; }},
        new FrameString ("DisplayName") {
            Get = (FrameBacker data) => (data as ProfileSelect)?.DisplayName ,
            Set = (FrameBacker data, string? value) => {(data as ProfileSelect)!.DisplayName = value; }},
